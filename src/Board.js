...
export function Board(props) {
  ...
  function handleClick(index) {
    ...
    if (props.logins["spects"].includes(props.userGlobal)) {
  ...
  status = winner
    ? `Ayy ${
        xIsNext ? props.logins["playerO"] : props.logins["playerX"]
      } won!! Sorry ${
        xIsNext ? props.logins["playerX"] : props.logins["playerO"]
      }, you lost :(`
      ...
      {winner || boardFull ? (
        <div>
          <div className="playAgain">
            <a>Click play again to record match results!</a>
            <br></br>
